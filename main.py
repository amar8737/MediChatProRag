...
from app.vectrostore_utils import create_faiss_index, retrive_relevant_docs
        ...
        if st.button("🚀 Process Documents", type="primary"):
            with st.spinner("Processing your medical documents..."):
                ...
                for file in uploaded_files:
                    ...
                    if isinstance(text_list, list):           # join if it's a list
                        text = " ".join(text_list)
                    else:
                        text = text_list
                ...
                chat_model = get_chat_model(EURI_API_KEY,model)
